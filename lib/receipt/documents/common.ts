 ...
 * versions. Ce fichier n'existe plus que pour laisser inchangés les 1 sites
 * d'import de `@/lib/receipt/documents/common` : le déplacement n'a rien à changer aux écrans.
 *
